...
@Database(entities = [Genres::class, PopularMovies::class, TopRatedMovies::class, TVAiringToday::class, TVPopular::class, TVTopRated::class, UpcomingMovies::class, ChillMaxRemoteKeys::class,MovieCredits::class], version = 1)
@TypeConverters()
